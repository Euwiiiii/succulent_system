    ...
    return (
        <div style={containerStyle}>
            ...
            <div style={{...cardStyle, zIndex: 10}}>
                ...
                <h2 style={{ color: '#105666', textAlign: 'center', marginBottom: '30px', fontSize: '24px', marginTop: 0 }}>Hi, Welcome Back!</h2>
                ...
                <div style={{ marginTop: '20px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '15px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', width: '100%' }}>
                        ...
                        <span style={{ padding: '0 10px', color: '#666', fontSize: '14px' }}>Don't have an account?</span>
                        <div style={{ flex: 1, height: '1px', backgroundColor: '#ccc' }}></div>
                    </div>
                    <button 
