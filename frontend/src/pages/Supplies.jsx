...
const Supplies = () => {
    ...
    return (
        <div style={{ padding: '40px', maxWidth: '800px', margin: '0 auto' }}>
            <h2 className="panel-header">Manage Supplies</h2>
            
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '15px', padding: '20px', backgroundColor: '#f8fffb', borderRadius: '10px', border: '1px solid var(--dark-green)', marginBottom: '30px' }}>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', marginTop: '20px' }}>
                <thead>
                    <tr style={{ backgroundColor: 'var(--dark-green)', color: 'white' }}>
                ...
                <tbody>
                    {supplies.map(s => (
                        <tr key={s._id} style={{ borderBottom: '1px solid #ddd' }}>
                            ...
                            <td style={tdStyle}>
                                <button onClick={() => handleEdit(s)} style={iconBtnStyle} title="Edit">
                                    <img src="/svg/edit.svg" style={{ width: '18px', height: '18px' }} alt="Edit" />
                                </button>
                                <button onClick={() => handleDelete(s._id, s.name)} style={{ ...iconBtnStyle, background: 'var(--rosy-brown)' }} title="Delete">
                                    <img src="/svg/delete.svg" style={{ width: '18px', height: '18px' }} alt="Delete" />
                                </button>
                            </td>
                        </tr>
                    ))}
...
const btnStyle = { padding: '10px', backgroundColor: 'var(--midnight-green)', color: 'white', border: 'none', borderRadius: '5px', cursor: 'pointer', fontWeight: 'bold' };
...
const iconBtnStyle = { margin: '0 5px', background: 'none', border: 'none', cursor: 'pointer', padding: '5px', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', borderRadius: '5px', transition: 'background 0.2s' };
